...
import { Music, Mail, Lock, User, ArrowLeft, Upload, Camera } from 'lucide-react';
...
export const SignupPage: React.FC<SignupPageProps> = ({ onBack, onSwitchToLogin }) => {
  ...
  const { signUp, signInWithGoogle, signInWithFacebook, uploadProfileImage } = useAuth();
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join DJFNDR to book amazing DJs</p>
        </div>
        ...
        <div className="space-y-3 mb-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center space-x-3 px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-red-500 text-white py-3 px-6 rounded-lg font-semibold hover:bg-red-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
